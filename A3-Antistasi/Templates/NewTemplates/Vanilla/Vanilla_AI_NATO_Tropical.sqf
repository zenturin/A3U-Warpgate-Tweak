...
_loadoutData setVariable ["sniHats", ["H_Booniehat_tna_F"]];
...
_sfLoadoutData setVariable ["helmets", ["H_HelmetB_TI_tna_F", "H_HelmetB_light_wdl", "H_HelmetSpecB_wdl", "H_HelmetB_plain_wdl"]];
