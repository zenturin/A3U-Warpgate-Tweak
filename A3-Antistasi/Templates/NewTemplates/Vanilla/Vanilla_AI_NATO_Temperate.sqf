...
_loadoutData setVariable ["sniHats", ["H_Booniehat_wdl"]];
...
_sfLoadoutData setVariable ["helmets", ["H_HelmetB_light_wdl", "H_HelmetSpecB_wdl", "H_HelmetB_plain_wdl"]];
_sfLoadoutData setVariable ["sniHats", ["H_Booniehat_wdl"]];
...
_militaryLoadoutData setVariable ["uniforms", ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_tshirt_mcam_wdL_f", "U_B_CombatUniform_vest_mcam_wdl_f"]];
...
_militiaLoadoutData setVariable ["uniforms", ["U_B_CombatUniform_mcam_wdl_f", "U_B_CombatUniform_tshirt_mcam_wdL_f", "U_B_CombatUniform_vest_mcam_wdl_f"]];
_militiaLoadoutData setVariable ["vests", ["V_TacVestIR_blk", "V_TacVest_blk", "V_BandollierB_blk", "V_Chestrig_blk"]];
_militiaLoadoutData setVariable ["backpacks", ["B_AssaultPack_blk"]];
_militiaLoadoutData setVariable ["helmets", ["H_HelmetB_light_black"]];
...
_crewLoadoutData setVariable ["uniforms", ["U_B_CombatUniform_vest_mcam_wdl_f"]];
_crewLoadoutData setVariable ["vests", ["V_PlateCarrier1_wdl"]];
