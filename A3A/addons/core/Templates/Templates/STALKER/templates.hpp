    ...
    class STALKER_Monolith : STALKER_Base
    {
        ...
        name = "Military";
        file = "STALKER_AI_Military";
        description = "[STALKER] Monolith soldiers were 'recruited' as the guardians of the C-Consciousness to repel stalkers. They are vastly superior guards than the Mutants since they retain most of their intelligence and fighting skills, although they are completely under the control of the C-Consciousness.";
    };
    ...
    class STALKER_Civ_Empty : STALKER_Base
    {
        ...
        description = "[STALKER] Due to the emissions, all civilian life was wiped out.  (This is an experimental change, disabling traffic and basically all human life other than the main factions)";
    };
    class STALKER_Civ_Zombie : STALKER_Civ_Empty
    {
        ...
        description = "[STALKER] Due to the emissions, all civilian life was wiped out, being replaced by zombies. (This is an experimental change, disabling traffic and replacing all civ spawns with zombies)";
    };
