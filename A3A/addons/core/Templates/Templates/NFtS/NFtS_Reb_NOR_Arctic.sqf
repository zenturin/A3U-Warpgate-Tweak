...
if (A3A_hasTFAR && startWithLongRangeRadio) then {_initialRebelEquipment append ["TFAR_SCR536","B_LIB_US_Radio"]};
//if (A3A_hasTFARBeta) then {_initialRebelEquipment append ["TFAR_microdagr","TFAR_anprc154"]};
if (A3A_hasTFARBeta && startWithLongRangeRadio) then {_initialRebelEquipment append ["TFAR_SCR536","B_LIB_US_Radio"]};
