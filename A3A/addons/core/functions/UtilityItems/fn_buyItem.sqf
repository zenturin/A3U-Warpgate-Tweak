...
if (_lastTimePurchase > time) exitwith {
    [
        localize "STR_A3A_buy_item_header", 
        format [localize "STR_A3A_buy_item_cooldown", ceil (_lastTimePurchase - time)]
...
if (_insufficientFunds) exitwith {[localize "STR_A3A_buy_item_header", localize "STR_A3A_buy_item_insuf_funds"] call A3A_fnc_customHint};
