...
if !(missionNamespace getVariable ["A3U_setting_enableCosmetics", false]) then {
...
} else {}; // It's annoying in some modsets (like halo or clone wars) to have a ton of modern cosmetic gear.
