...
if (_newGame) then {
	...
	localize "STR_hints_new_game_header" hintC [localize "STR_hints_new_game_1", localize "STR_hints_new_game_2", localize "STR_hints_new_game_3"];
} else {
	player allowDamage false;
	_disabledPlayerDamage = true;
	format [localize "STR_hints_new_game_petros_dead_header",name petros] hintC format [
		localize "STR_hints_new_game_petros_dead_text",name petros
	];
};
