...
switch (true) do {
    ...
    case ("CUP" isEqualTo (_templateParts select 0) && {isClass (configFile >> "CfgFactionClasses" >> "rhs_faction_usarmy")}): {
        Info("Initializing CUP + RHS trader.");
        [_traderX, ["cup", "rhs"]] call HALs_store_fnc_addTrader;
    };
