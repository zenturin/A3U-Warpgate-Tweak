...
Info_1("Central position: %1", str _position);
...
private _population = round ((random [1, (civPedestrians / 2), civPedestrians]));
...
presenceMain setVariable ["#onCreated", (compileFinal "_this call A3A_fnc_CIVinit;")];
...
Info_1("%1 Civilian Presence Modules created, job has been completed.", _marker);