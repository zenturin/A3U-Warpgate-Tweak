//SPE_IFA3
		...
		class smgspe{
			...
			ITEM(SPE_M1A1_Thompson, 400, RIFLE_STOCK); // 30rnd mag: SPE_30Rnd_792x33  SPE_30Rnd_792x33_t
		...
		class specialweaponsspe{
			...
			ITEM(SPE_GrW278_1_Barrel, 200, MISC_STOCK);
			ITEM(SPE_GrW278_1_Stand, 200, MISC_STOCK);
			ITEM(SPE_MLE_27_31_Barrel, 200, MISC_STOCK);
			ITEM(SPE_MLE_27_31_Stand, 200, MISC_STOCK);
			ITEM(SPE_M1_81_Barrel, 200, MISC_STOCK);
