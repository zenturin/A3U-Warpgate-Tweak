class A3A_BuyVehicleDialog : A3A_DefaultDialog
{
  ...
  onLoad = "['onLoad', SCRT_fnc_ui_populateVehicleBox, 'BUYFIA'] spawn A3A_fnc_buyVehicleDialog";
...
class A3A_BlackMarketDialog : A3A_BuyVehicleDialog
{
  onLoad = "['onLoad', SCRT_fnc_ui_populateBlackMarket, 'BUYBLACKMARKET'] spawn A3A_fnc_buyVehicleDialog";
